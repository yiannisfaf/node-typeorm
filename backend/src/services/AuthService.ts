...
//Access token can be refreshed after 15 mins after it expires.
//Access token can only be refreshed if User has valid session in Redis.
...
//To log User out we need to send expired cookies to Users browser.
//To do this we send cookies with empty string and maxAge of -1
//And we need to delete User session from Redis
